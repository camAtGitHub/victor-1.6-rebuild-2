 ...
 * 2026-07: shell host scoping, safe onData, row cap, scoped DataTables (#tab-audioevents)
 */
...
(function(myMethods, sendData) {
  ...
  function $host() {
    ...
    try {
      var el = document.getElementById( 'tab-audioevents' );
      if( el ) { return $(el); }
    } catch( e ) {}
    return $();
  }
  ...
  function DrawTable() {
    ...
    try {
      ...
      console.warn( 'audioEvents: DrawTable failed', e );
    }
  }
  ...
  myMethods.init = function( elem ) {
    ...
    $host().find( '.toggleViz' ).on( 'click', function( e ) {
      ...
      try {
        ...
        console.warn( 'audioEvents: column toggle failed', eToggle );
      }
    });
